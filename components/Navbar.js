  ...
  return (
    <nav className="navbar navbar-expand-sm navbar-light bg-darkGray px-8 text-white py-3 sm:py-4">
      <div className="container-fluid">
        ...
        <button
          className="navbar-toggler bg-gray-200"
          type="button"
        ...
        <div
          className="collapse navbar-collapse sm-navbar:justify-end"
          id="navbarNav"
        >
          <div className="navbar-nav">
            {user[0] ? (
              ...
              <div className="sm-navbar:flex text-center my-2">
                <button className="mr-6" onClick={handleLoginForm}>
                  Sign in
                </button>
            ...
            {registerFormOpen && (
              <RegisterForm closeForm={handleRegisterFormClose} />
            )}
          </div>
        </div>
      </div>
