  ...
  return (
    <div className="text-gray-100">
        ...
        {user[0] ? null : <div className="max-w-screen-sm w-10/12 text-center mx-auto my-10">
          <h2 className="mt-6 mb-3 text-xl">About <i aria-hidden className="fas fa-comment ml-3 text-lightBlue"></i></h2>
        ...
        {user[0] && <CoinList />}
        <TopTenList />
        {user[0] && <div className="md:flex justify-center sm:mt-14 mt-10 mb-10">
          <NewTransaction />
          <TransactionList />
        </div>}
    </div>
